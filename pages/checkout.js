...
const Checkout = ({ cart, subTotal, addToCart, removeFromCart }) => {
  return (
    <div className='container px-2 sm:m-auto'>
      ...
      <div className="mx-auto flex my-2">
        <div className="px-2 w-1/2" >
          <div className="mb-4">
            ...
            <input type="phone" id="state" name="state" className="w-full bg-white rounded border border-gray-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
          </div>
        </div>
        <div className="px-2 w-1/2" >
          <div className="mb-4">
      ...
      <div
        className="sideCart bg-pink-100 p-6 my-4"
      >
