...
const Shirts = ({ products }) => {
  return (
    <div>
       <Head>
        <title>Shirts -MensCloset.com</title>
        <meta
          name="viewport"
      ...
      <section className="text-gray-600 body-font min-h-screen">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4 justify-center">
            {Object.keys(products).length === 0 && <p className='mx-5'>Sorry all the Shirts are out of stock. New Stock coming soon! Stay Tuned!</p>}
